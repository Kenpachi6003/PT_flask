...
def main():
    ...
    add_workouts_to_model(
        Test_Workouts, mid_chest_workouts, "chest", "mid chest", list_of_videos()
    )
    add_workouts_to_model(
        Test_Workouts, lower_chest_workouts, "chest", "lower chest", list_of_videos()
    )
    add_workouts_to_model(
        Test_Workouts, workouts_for_back, "back", None, list_of_videos()
    )
    add_workouts_to_model(
        Test_Workouts,
    ...
    add_workouts_to_model(
        Test_Workouts, workouts_for_tricep, "arms", "triceps", list_of_videos()
    )
    add_workouts_to_model(
    ...
    add_workouts_to_model(
        Test_Workouts, workouts_for_hamstrings, "legs", "hamstrings", list_of_videos()
    )
    add_workouts_to_model(
